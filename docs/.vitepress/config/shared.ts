...
const sharedHead: HeadConfig[] = [
  ...
  ['meta', { name: 'geo.position', content: '48.7789239;8.2154413' }],
  ...
  themeConfig: {
    ...
    socialLinks: [
      ...
      { icon: 'instagram', link: 'https://www.instagram.com/da_michele_badenbaden/', ariaLabel: 'Instagram' },
      {
        ...
        link: 'https://maps.apple.com/?ll=48.7789239,8.2154413&address=Ristorante+da+Michele,Rheinstrasse+109,Baden-Baden,Germany&z=19&dirflg=d',
        ariaLabel: 'Apple Maps'
      },
      {
        icon: 'googlemaps',
        link: 'https://www.google.com/maps/dir/?api=1&origin=&destination=Ristorante+Da+Michele%2C+Rheinstr.+109%2C+76532+Baden-Baden%2C+Germany&travelmode=driving&dir_action=navigate&center=48.7789239,8.2154413&zoom=19&basemap=roadmap&layer=traffic',
        ariaLabel: 'Google Maps'
      },
      { icon: 'here', link: 'https://share.here.com/r/mylocation/48.7789239,8.2154413?m=d', ariaLabel: 'HERE Maps' },
      {
        icon: 'waze',
        link: 'https://www.waze.com/ul?q=Ristorante%20Da%20Michele&ll=48.7789239,8.2154413&navigate=yes',
